...
| Windows  | File     | `%USERPROFILE%\.github\.credentials.json` |
| Linux    | File     | `~/.github/.credentials.json`             |
...
### Hook Settings (`.github/settings.json`)
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node .github/hooks/usage-context-awareness.cjs"
          }
        ]
      }
    ]
