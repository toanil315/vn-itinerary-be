...
3. **.github/.env file**
   ...
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > .github/.env
   ```

4. **.github/skills/.env file** (shared across all Gemini skills)

   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > .github/skills/.env
   ```

5. **Skill directory `.env` file**
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > .github/skills/your-skill/.env
   ```
