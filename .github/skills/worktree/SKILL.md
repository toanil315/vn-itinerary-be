...
```bash
node .github/skills/worktree/scripts/worktree.cjs info --json
```
...
```bash
node .github/skills/worktree/scripts/worktree.cjs create "<PROJECT>" "<SLUG>" --prefix <TYPE>
```

**Standalone:**

```bash
node .github/skills/worktree/scripts/worktree.cjs create "<SLUG>" --prefix <TYPE>
```
