...
After creating plan: `node .github/scripts/set-active-plan.cjs {plan-dir}`
...
| ----------------- | --------------------------------- | ----------------------------------------------- |
| `/plann archive`  | `references/archive-workflow.md`  | Archive plans + write journal entries           |
| `/plann red-team` | `references/red-team-workflow.md` | Adversarial plan review with hostile reviewers  |
| `/plann validate` | `references/validate-workflow.md` | Validate plan with critical questions interview |
